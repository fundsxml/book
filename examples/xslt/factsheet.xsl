...
<!-- Chapter 2, Section 2.12.3 / Chapter 12, Section 12.3.7 Example 1
     FundsXML to HTML fact sheet (same as factsheet_simple.xsl, kept for
     backward compatibility with Chapter 12 references)
     Run: xsltproc factsheet.xsl ../europa_growth_fund.xml > factsheet.html -->
